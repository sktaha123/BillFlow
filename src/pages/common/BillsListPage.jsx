    ...
    <div className="space-y-6 max-w-6xl mx-auto animate-in fade-in duration-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <h1 className="text-3xl font-semibold text-slate-900 tracking-tight">Department Remuneration Bills</h1>
          <p className="text-xs sm:text-sm text-slate-500">
            Comprehensive archive and search for all paper setting remuneration claims.
          </p>
        </div>
      ...
      {/* Filter Bar */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 p-4 rounded-xl bg-white/80 backdrop-blur-md border border-slate-200/80 shadow-2xs">
        <div>
